...
{
    /// <inheritdoc />
    public partial class Added_Pizzas_table_and_related_tables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PizzaSizes", x => new { x.PizzaId, x.SizeId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PizzaSizes_Sizes_SizeId",
                        column: x => x.SizeId,
