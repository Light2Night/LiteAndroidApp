...
namespace Api.Migrations
{
    ...
    [Migration("20240718133318_Added_SpecificationNames_and_SpecificationValues")]
    partial class Added_SpecificationNames_and_SpecificationValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entities.PizzaSpecificationValue", b =>
                {
                    b.Property<long>("PizzaId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("PizzaId", "SpecificationValueId");

                    b.HasIndex("SpecificationValueId");

                    b.ToTable("PizzaSpecificationValues", (string)null);
                });
            ...
            modelBuilder.Entity("Model.Entities.SpecificationName", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SpecificationNames", (string)null);
                });

            modelBuilder.Entity("Model.Entities.SpecificationValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("SpecificationNameId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SpecificationNameId");
            ...
            modelBuilder.Entity("Model.Entities.PizzaSpecificationValue", b =>
                {
                    ...
                    b.HasOne("Model.Entities.SpecificationValue", "SpecificationValue")
                        .WithMany("Pizzas")
            ...
            modelBuilder.Entity("Model.Entities.SpecificationValue", b =>
                {
                    b.HasOne("Model.Entities.SpecificationName", "SpecificationName")
                        .WithMany("Values")
                        .HasForeignKey("SpecificationNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SpecificationName");
                });
            ...
            modelBuilder.Entity("Model.Entities.Category", b =>
                {
                    ...
                    b.Navigation("SpecificationNames");
                });
