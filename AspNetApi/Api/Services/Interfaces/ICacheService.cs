...
public interface ICacheService {
	...
	Task SetCacheAsync(string controllerName, string actionName, object argument, object value, TimeSpan? expiry);
	Task SetCacheAsync(ActionDto action, object argument, object value, TimeSpan? expiry);
